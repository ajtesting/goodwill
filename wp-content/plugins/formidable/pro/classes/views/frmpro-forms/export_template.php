...
echo '<?php ';
?>    
$values['name'] = '<?php echo $form->name ?>';
$values['description'] = '<?php echo $form->description ?>';
...
$values['options']['submit_value'] = '<?php echo isset($form->options['submit_value']) ? $form->options['submit_value'] : $frm_settings->submit_value ?>'; 
$values['options']['success_msg'] = '<?php echo isset($form->options['success_msg']) ? $form->options['success_msg'] : $frm_settings->success_msg ?>';
$values['options']['show_form'] = <?php echo isset($form->options['show_form']) ?  $form->options['show_form'] : 0 ?>;
$values['options']['akismet'] = <?php echo isset($form->options['akismet']) ? $form->options['akismet'] : 0 ?>;
$values['options']['custom_style'] = <?php echo isset($form->options['custom_style']) ? $form->options['custom_style'] : 0 ?>;
$values['options']['before_html'] = '<?php echo isset($form->options['before_html']) ? $form->options['before_html'] : FrmFormsHelper::get_default_html('before') ?>';
$values['options']['after_html'] = '<?php echo isset($form->options['after_html']) ? $form->options['after_html'] : FrmFormsHelper::get_default_html('after') ?>';
...
$values['options']['logged_in_role'] = '<?php echo (isset($form->options['logged_in_role'])) ? $form->options['logged_in_role'] : '' ?>';
$values['options']['editable_role'] = '<?php echo (isset($form->options['editable_role'])) ? $form->options['editable_role'] : '' ?>';
...
$values['options']['edit_value'] = '<?php echo (isset($form->options['edit_value'])) ? $form->options['edit_value'] : $frmpro_settings->update_value ?>';
$values['options']['edit_msg'] = '<?php echo (isset($form->options['edit_msg'])) ? $form->options['edit_msg'] : '' ?>';

$values['options']['plain_text'] = <?php echo (isset($form->options['plain_text'])) ? $form->options['plain_text'] : 0 ?>;
//$values['options']['reply_to'] = '<?php echo (isset($form->options['reply_to'])) ? $form->options['reply_to'] : '' ?>';
//$values['options']['reply_to_name'] = '<?php echo (isset($form->options['reply_to_name'])) ? $form->options['reply_to_name'] : '' ?>';
$values['options']['email_subject'] = '<?php echo (isset($form->options['email_subject'])) ? $form->options['email_subject'] : '' ?>';
$values['options']['email_message'] = '<?php echo (isset($form->options['email_message'])) ? $form->options['email_message'] : '[default-message]' ?>';
...
//$values['options']['ar_email_to'] = '<?php echo (isset($form->options['ar_email_to'])) ? $form->options['ar_email_to'] : '' ?>';
$values['options']['ar_reply_to'] = '<?php echo (isset($form->options['ar_reply_to'])) ? $form->options['ar_reply_to'] : '' ?>';
$values['options']['ar_reply_to_name'] = '<?php echo (isset($form->options['ar_reply_to_name'])) ? $form->options['ar_reply_to_name'] : '' ?>';
$values['options']['ar_email_subject'] = '<?php echo (isset($form->options['ar_email_subject'])) ? $form->options['ar_email_subject'] : '' ?>';
$values['options']['ar_email_message'] = '<?php echo (isset($form->options['ar_email_message'])) ? $form->options['ar_email_message'] : '' ?>';

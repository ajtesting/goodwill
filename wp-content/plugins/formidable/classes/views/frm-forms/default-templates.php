    ...
    <tr class="<?php echo $alternate ?>">
        <td class="post-title">
            ...
            <div class="row-actions">
                ...
                <span><a href="?page=formidable&amp;action=duplicate&amp;id=<?php echo $form->id; ?>" title="<?php _e('Copy', 'formidable') ?> <?php echo htmlentities(stripslashes($form->name)); ?>"><?php _e('Create Form from Template', 'formidable') ?></a></span> |
                <?php } ?>

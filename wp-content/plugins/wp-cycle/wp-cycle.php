...
<?php $custom_fields = get_post_custom(4); ?>
...
jQuery(document).ready(function($) {
	$("#<?php echo $wp_cycle_settings['div']; ?>").cycle({ 
	    ...
	    pagerAnchorBuilder: function(idx, slide) {
	    	var rotatorLinks = $('#main-content #main-left #rotator a');
	    	switch( idx ) {
	    		case 0:
	    			return '<span><h4><?= addslashes($custom_fields['header1'][0]) ?></h4><a href="' + rotatorLinks[0] + '"><?= addslashes($custom_fields['blurb1'][0]) ?></a></span>';
	    			break;
	    		case 1:
	    			return '<span><h4><?= addslashes($custom_fields['header2'][0]) ?></h4><a href="' + rotatorLinks[1] + '"><?= addslashes($custom_fields['blurb2'][0]) ?></a></span>';
	    			break;
	    		case 2:
	    			return '<span class="last-item"><h4><?= addslashes($custom_fields['header3'][0]) ?></h4><a href="' + rotatorLinks[2] + '"><?= addslashes($custom_fields['blurb3'][0]) ?></a></span>';
	    			break;
	    		default:
	    			break;
	    	} 
